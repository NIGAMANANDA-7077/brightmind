                    ...
                    <div className="flex items-center justify-between mb-3">
                        <div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold text-gray-900">{reply.authorName}</span>
                                {(reply.authorRole === 'Mentor' || reply.authorRole === 'Teacher') && (
                                    <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-100 text-blue-700 text-[10px] font-bold uppercase tracking-wider">
                                        <BadgeCheck size={12} fill="currentColor" className="text-blue-500" /> {reply.authorRole === 'Teacher' ? 'Teacher' : 'Mentor'}
                                    </span>
                                )}
