...
const TestimonialCard = ({ testimonial }) => (
  <div className="bg-[#fafaf9]/80 backdrop-blur-sm rounded-3xl p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col h-full w-[400px] flex-shrink-0 mx-4">
    {/* Quote Icon */}
    <div className="mb-6">
      <Quote className="w-10 h-10 text-[#e9d5ff] fill-[#e9d5ff]" />
    </div>

    {/* Content */}
    <p className="text-gray-700 leading-relaxed mb-8 flex-1 font-medium italic">
      "{testimonial.quote}"
    </p>
