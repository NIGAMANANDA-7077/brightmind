...
const PublicCourseCard = ({ course }) => {
    return (
        <Link to={`/courses/${course.id}`} className="block h-full group">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full">
                {/* Thumbnail */}
                ...
                <div className="p-6 flex flex-col flex-1">
                    ...
                    <div
                        className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#f3f4f6] text-gray-900 rounded-xl text-sm font-bold group-hover:bg-[#8b5cf6] group-hover:text-white transition-all group-hover:shadow-lg group-hover:shadow-purple-500/20"
                    >
